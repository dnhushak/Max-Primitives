...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 423.0, 396.0, 72.0, 20.0 ],
					"text" : "Elevation"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Elevation (rad)",
					"comment" : "Elevation (rad)",
					"id" : "obj-29",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 396.0, 54.0, 20.0 ],
					"text" : "Azimuth"
				}
